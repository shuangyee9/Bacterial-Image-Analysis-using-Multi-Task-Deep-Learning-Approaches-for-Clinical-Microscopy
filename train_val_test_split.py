...
# Originally from GitHub user EdjeElectronics: 
https://github.com/EdjeElectronics/TensorFlow-Lite-Object-Detection-on-Android-and-Raspberry-Pi/tree/master/util_scripts

# Randomly splits images to 70% train, 30% testing and moves them to their respective folders. 
...
train_percent = 0.7  # 80% of the files go to train
val_percent = 0.3 # 10% go to validation (test)
test_percent = 0.0 # 10% go to test
