...
Original file is located at
    https://colab.research.google.com/drive/1d4fuuP4i14dfb0upHVxznbp1PBkTLYG_

This notebook uses [the TensorFlow 2 Object Detection API](https://github.com/tensorflow/models/tree/master/research/object_detection) to train an EfficientDet model with a custom dataset.
